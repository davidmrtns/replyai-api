...
from app.routers.integrations.digisac.digisac_helpers import get_department_from_db, get_digisac_client, get_digisac_client_from_db
...
@router.put('/{company_slug}/departments/{department_id}', response_model=DigisacDepartmentSchemaEmpresa)
...
async def create_digisac_client(
    ...
    if digisac_client_db:
        raise HTTPException(status_code=404, detail="This company already has a Digisac client registered")
