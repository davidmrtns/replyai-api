...
def create_agenda(
    ...
    return create_agenda_service(request, company_id, db)
...
def update_agenda(
    ...
    return update_agenda_service(agenda_id, request, company_id, db)
...
def delete_agenda(
    ...
    return delete_agenda_service(agenda_id, company_id, db)


@router.get("/timezones")
def list_timezones():
    return list_timezones_service()
