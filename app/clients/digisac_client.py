...
class DigisacClient(MessageClient):
    ...
    def send_message(
        ...
        if audio_message_base64 or media_message:
            file = {
                ...
                'mimetype': 'audio/mpeg' if audio_message_base64 else media_message.mimetype,
                'name': 'audio_response' if audio_message_base64 else media_message.filename
            }
            payload['file'] = file
            payload['text'] = ''
    ...
    def get_contact_data(self, request: DigisacRequest) -> ContactData:
        ...
        if response.status_code == 200:
            ...
            contact_name = json_response.get('name', ''), # TODO: maybe improve typing
    ...
    def get_contact_id(self, phone_number: str, contact_name: str) -> str:
        ...
        if contact_id is None:
            ...
            response_create_contact = requests.post(endpoint, headers=self.headers, json=payload)

            if response_create_contact.status_code == 200:
                response_create_contact_json = json.loads(response_create_contact.content)
    ...
    def get_ticket_and_last_message_ids(self, contact_id: str) -> Tuple[str | None, str | None]:
